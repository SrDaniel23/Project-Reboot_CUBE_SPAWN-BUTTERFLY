...
UObject* GetEventScripting()
{
	...
	if (Fortnite_Version == 6.21)
		Scripting = FindObject("/Game/Athena/Maps/Athena_POI_Foundations.Athena_POI_Foundations.PersistentLevel.BP_Butterfly_4");
...
void Events::StartEvent()
{
	...
	if (Fortnite_Version == 5.30) // Cube appearence and crack closure
	{
	...
	else if (Fortnite_Version == 6.21) // Butterfly
	{
	...
	else if (Fortnite_Version == 7.30) // Marshmello concert 
	{
	...
	if (bHasBeenLoaded) // These versions require manual loading stuff
	{
		...
		else if (Fortnite_Version == 9.40 || Fortnite_Version == 9.41) // Cattus vs Doggus
		{
			auto Scripting = GetEventScripting();
		...
		else if (Fortnite_Version == 10.40) // End event V1
		{
			auto Scripting = GetEventScripting();
		...
		else if (Fortnite_Version == 11.30) // Star Wars event
		{
			auto Scripting = GetEventScripting();
		...
		else if (Fortnite_Version == 12.41) // Travis scott
		{
			auto Loader = GetEventLoader();
		...
		else if (Fortnite_Version == 12.61) // Device event
		{
			// if (false)
			{
				auto Scripting = GetEventScripting();
		...
		else if (Fortnite_Version == 14.60) // Glakus 
		{
			auto Scripting = GetEventScripting();
			auto Loader = GetEventLoader();
